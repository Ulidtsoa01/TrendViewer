                ...
                <li>
                  ...
                  <ol>
                    <li>
                      ...
                      <a href="https://www.marketinout.com/chart/market.php?breadth=advance-decline-line" target="_blank">
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <a target="_blank" href="https://ycharts.com/indicators/us_pmi#:~:text=US%20ISM%20Manufacturing%20PMI%20is,manufacturing%20sector%20in%20the%20US.">
                            US ISM Manufacturing PMI
                          </a>
                        </li>
                        <li>
                          <a target="_blank" href="https://ycharts.com/indicators/us_ism_non_manufacturing_index">
                            US ISM Services PMI
                          </a>
                        </li>
                        <li>
                          <a target="_blank" href="https://ycharts.com/indicators/us_initial_claims_for_unemployment_insurance">
                    ...
                    <li>
                      Commodities:{' '}
                      <a target="_blank" href="http://futures.tradingcharts.com/chart/CO/W">
                        Weekly Light Crude Oil (Pit)
                      </a>
                      ,
                      <a target="_blank" href="https://www.bullionvault.com/gold-price-chart.do">
                        Gold Price
                      </a>
                      ,
                      <a target="_blank" href="https://www.bullionvault.com/silver-price-chart.do">
                        Silver Price
                      </a>
                    </li>
                    <li>
                      Write{' '}
                      <a target="_blank" href="#/market/assessments">
                        Market Assessments
                      </a>
                    </li>
                  </ol>
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      ...
                      (
                      <a target="_blank" href="http://www.sectorspdr.com/">
                        Sector SPDRs Home
                      </a>
                      )
                    </li>
