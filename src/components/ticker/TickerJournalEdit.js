...
function TickerJournalEdit(props) {
  const revalidator = useRevalidator();
  const { journal, tickerId, tickerName, toGeneralMode } = props;
    ...
    <div className={styles.container}>
      <Form className={styles.form} onSubmit={handleSubmit}>
        <Form.Group className="mb-3" controlId="tickerName">
          ...
          <Form.Control type="text" value={tickerName} disabled />
        </Form.Group>
        ...
        <Container>
          <Row>
            ...
            <Col>
              <Button variant="primary" onClick={toGeneralMode}>
                Cancel
              </Button>
            </Col>
            {journal && (
...
export default TickerJournalEdit;
