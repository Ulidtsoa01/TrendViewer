          ...
          <Container>
            <Row>
              ...
              <Col lg="2">
                <dl>
                  <dt>Original Cash</dt>
                  <dd>{account.originalCashAmount ? account.originalCashAmount.toFixed(2) : ''}</dd>
                </dl>
              </Col>
              <Col lg="2">
                <dl>
                  <dt>Value</dt>
                  <dd>{account.totalAmount ? account.totalAmount.toFixed(2) : ''}</dd>
                </dl>
              </Col>
              <Col lg="2">
                <dl>
                  <dt>Gain</dt>
                  <dd>{account.gain ? account.gain.toFixed(2) : ''}</dd>
                </dl>
              </Col>
              <Col lg="2">
                <dl>
                  <dt>Current Cash</dt>
                  <dd>{account.cashAmount ? account.cashAmount.toFixed(2) : ''}</dd>
                </dl>
              </Col>
              <Col lg="2">
                <dl>
                  <dt>Cash Percentage</dt>
                  <dd>{calcAccountCashPercent(account)}%</dd>
                </dl>
              </Col>
            </Row>
          </Container>
