...
function ActivityEdit(props) {
    ...
    return (
        <Card className={styles.activityPanel}>
            <Card.Header><Card.Title>Create Activity for {account.name}</Card.Title></Card.Header>
            <Card.Body>
                <Form className={styles.editActivityForm} onSubmit={handleSubmit}>
                    ...
                    <Container>
                        <Row>
                            <Col><Button variant="primary" type="submit">{activity ? 'Update' : 'Create'}</Button></Col>
                            <Col><Button variant="primary" onClick={onCancel}>Cancel</Button></Col>
                            {activity &&
