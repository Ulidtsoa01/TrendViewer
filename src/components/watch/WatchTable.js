...
const columns = [
    ...
    { title: 'Volume Percent', field: 'volumePercent', sortable: true },
...
function WatchTable() {
    ...
    return (
      <SortedTable title={PortfolioMap[watchId]} data={watchList} columns={columns} keyField='tickerId' preSlide={watchId} 
            addUrl={'/rest/watch/add/' + watchId + '/'} deleteUrl={'/rest/watch/remove/' + watchId + '/'}/>
    );
};
