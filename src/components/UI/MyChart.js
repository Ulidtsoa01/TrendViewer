            ...
            <div>
                <div>
                    <ButtonGroup className="mb-0">
                        <ToggleButton id="climax" type="checkbox" variant="outline-secondary" checked={climaxChecked} value="1" onChange={handleClimaxChecked}>Climax</ToggleButton>
                        <ToggleButton id="BB" type="checkbox" variant="outline-secondary" checked={bbChecked} value="1" onChange={handleBBChecked}>BB</ToggleButton>
                        <ToggleButton id="SMA" type="checkbox" variant="outline-secondary" checked={smaChecked} value="1" onChange={handleSMAChecked}>SMA</ToggleButton>
                        <Button id="ClimaxGroupToggle" variant="secondary" onClick={handleClimaxGroupClick}>Toggle</Button>
                    </ButtonGroup>
                    <ButtonGroup className="mb-0">
                        <ToggleButton id="Activities" type="checkbox" variant="outline-secondary" checked={buySellChecked} value="1" onChange={handleBuySellChecked}>Buy/Sell</ToggleButton>
                    </ButtonGroup>
                    <ButtonGroup className="mb-0">
                        {toolRadios.map((radio, idx) => (
                            <ToggleButton
                                ...
                                name="radio"
                                value={radio.value}
                                checked={toolRadioValue === radio.value}
                                onChange={handleToolRadiosChange}
                            >
                                {radio.name}
                            </ToggleButton>
                        ))}
                    ...
                    <ButtonGroup className="mb-0">
                        <Button id="sizeUp" variant="secondary" onClick={handleSizeUpClick}>+</Button>
                        <Button id="sizeDown" variant="secondary" onClick={handleSizeDownClick}>-</Button>
                        <Button id="windowUp" variant="secondary" onClick={handleWindowUpClick}>&lt;</Button>
                        <Button id="windowDown" variant="secondary" onClick={handleWindowDownClick}>&gt;</Button>
                    </ButtonGroup>
                </div>
                <canvas
                    ref={canvasRef} width="2730" height="1150"
                    tabIndex="0" onKeyUp={keyUpHandler} onMouseDown={mouseDownHandler} onMouseUp={mouseUpHandler} onMouseMove={mouseMoveHandler}
                />
            </div>
        </div>
    );
